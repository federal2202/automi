    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          className="rounded-lg !bg-[#ffffff]/5 !border-[#ffffff]/20 text-white placeholder:text-[#ffffff]/50"
          required
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          className="rounded-lg !bg-[#ffffff]/5 !border-[#ffffff]/20 text-white placeholder:text-[#ffffff]/50 [&::-webkit-calendar-picker-indicator]:invert [&::-webkit-calendar-picker-indicator]:opacity-70 [&::-webkit-calendar-picker-indicator]:hover:opacity-100 [&::-webkit-calendar-picker-indicator]:cursor-pointer"
          required
        />
      </div>
